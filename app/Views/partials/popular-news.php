...
<div class="widget-content">
    <article class="post post-3 post-3_mod-a clearfix">
        <div class="entry-media"><a href="<?= base_url(); ?>/assets/media/content/post/100x100/1.jpg"
                class="prettyPhoto"><img src="<?= base_url(); ?>/assets/media/content/post/100x100/1.jpg" alt="Foto"
    ...
    <article class="post post-3 post-3_mod-a clearfix">
        <div class="entry-media"><a href="<?= base_url(); ?>/assets/media/content/post/100x100/2.jpg"
                class="prettyPhoto"><img src="<?= base_url(); ?>/assets/media/content/post/100x100/2.jpg" alt="Foto"
                    class="img-responsive" /></a></div>
        <div class="entry-main">
            <div class="entry-header">
    ...
    <article class="post post-3 post-3_mod-a clearfix">
        <div class="entry-media"><a href="<?= base_url(); ?>/assets/media/content/post/100x100/4.jpg"
                class="prettyPhoto"><img src="<?= base_url(); ?>/assets/media/content/post/100x100/4.jpg" alt="Foto"
                    class="img-responsive" /></a></div>
        <div class="entry-main">
            <div class="entry-header">
    ...
    <article class="post post-3 post-3_mod-a clearfix">
        <div class="entry-media"><a href="<?= base_url(); ?>/assets/media/content/post/100x100/5.jpg"
                class="prettyPhoto"><img src="<?= base_url(); ?>/assets/media/content/post/100x100/5.jpg" alt="Foto"
                    class="img-responsive" /></a></div>
        <div class="entry-main">
            <div class="entry-header">
                <h2 class="entry-title"><a href="<?= site_url(); ?>/detail">Aliquip exea comod
