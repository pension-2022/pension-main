            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="top-header__ticker">
                        <ul id="myUl">
                            <li class="news-item"><a href="/detail" class="news-item__link">Uber
                                    offers $29m 'safe ride' settlement</a><i class="icon fa fa-adjust"></i></li>
                            <li class="news-item"><a href="/detail" class="news-item__link">The
                                    robot that camouflages itself</a><i class="icon fa fa-adjust"></i></li>
                            <li class="news-item"><a href="/detail" class="news-item__link">Luxury
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul class="social-links list-inline">
                        ...
                        <li><a href="rss.com" class="social-links__item_link"><i class="icon fa fa-rss"></i></a>
                        </li>
                    </ul>
                </div>
                <!-- <div class="col-md-1"></div> -->
                <div class="col-md-4">
                    <div style="width: 200px; margin: auto;"><a href="/" class="logo"><img style="margin: auto;"
                                src="assets/media/dpbri-color.svg" alt="Logo"
